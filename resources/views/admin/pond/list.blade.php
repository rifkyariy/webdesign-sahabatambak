          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Daftar Kolam Anda</h4>
                    <p class="card-description"> Berikut merupakan daftar kolam yang anda miliki dan terindeks ke dalam sistem.
                    </p>
                    <div class="table-responsive">
                      <table class="table table-striped" id="pond-table" style="width:100%">
                        <thead>
                          <tr>
                            <th> Nama Kolam </th>
                            <th> Jenis Ikan </th>
...
<script type="text/javascript">
  $(function () {
    ...
    var table = $('#pond-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('api.pond.list') }}",
        columns: [
            {data: 'name', name: 'name'},
            {data: 'fish_type', name: 'fish_type'},
            {data: 'fish_age', name: 'fish_age'},
            {data: 'pond_size', name: 'pond_size'},
            {
                data: 'action', 
                name: 'action', 
                orderable: true, 

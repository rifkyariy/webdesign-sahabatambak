                  ...
                  <div class="card-body py-0 px-0 px-sm-3">
                    <div class="row align-items-center">
                      <div class="col-4 col-sm-3 col-xl-2">
                        <img src="{{ asset('admin/images/dashboard/Group126@2x.png') }}" class="gradient-corona-img img-fluid" alt="">
                      </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-4">
                        <div class="">
                          <h3 class="mb-0">Kolam Nila</h3>
                          <p class="text-muted ml-2 my-2 font-weight-medium">Jenis Ikan : <b class="text-success">Nila</b></p>
                          <p class="text-muted ml-2 my-2 font-weight-medium">Umur Budidaya : <b class="text-success">30 Hari</b></p>
                          <p class="text-muted ml-2 mb-2 font-weight-medium">Luas Kolam : <b class="text-success">200 m<sup>2</sup></b></p>
                        </div>
                      </div>
                        ...
                        <div class="preview-list">
                          <div class="preview-item border-bottom">
                            ...
                            <div class="preview-item-content d-sm-flex flex-grow">
                              <div class="flex-grow">
                                <h6 class="preview-subject">Suhu Kolam Dibawah 35 °C</h6>
                                <p class="text-muted mb-0">Nafsu makan ikan akan berkurang dan ada kemungkinan ikan akan mati</p>
                              </div>
                          ...
                          <div class="preview-item border-bottom">
                            ...
                            <div class="preview-item-content d-sm-flex flex-grow">
                              <div class="flex-grow">
                                <h6 class="preview-subject">pH Kolam Dibawah 7</h6>
                                <p class="text-muted mb-0">Nafsu makan ikan akan berkurang dan ada kemungkinan ikan akan mati, berikan aliran air baru agar pH stabil</p>
                              </div>
                              <div class="mr-auto text-sm-right pt-2 pt-sm-0">
